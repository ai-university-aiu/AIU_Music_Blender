...
The AIU_Music_Blender GitHub repository, hereinafter known as "AIU_Music_Blender",
...
/home/ccaitwo/AIU_Music_Blender/docs/AIU_Music_Blender_Vision_Document.txt
...
AIU_Music_Blender therefore performs ALL audio analysis locally, on the user's own machine,
...
(Note: cousin repositories carry six SPARCD documents; AIU_Music_Blender is the family's first
...
specification file:
/home/ccaitwo/AIU_Music_Blender/docs/ENGLISH_READABLE_CODE_MANUSCRIPT.txt
...
A directory /home/ccaitwo/AIU_Music_Blender/docs/archive/ shall exist.
...
Any and all code changes to AIU_Music_Blender will be accompanied by mirrored changes to
...
/home/ccaitwo/AIU_Music_Blender/docs/User_Tutorial_v1.txt
/home/ccaitwo/AIU_Music_Blender/docs/Developer_Tutorial_v1.txt

The User Tutorial teaches a beginner, learner, layperson, newcomer, or novice how to USE
AIU_Music_Blender in all three ways it runs (command line, localhost web page, Ubuntu
...
so each always describes the AIU_Music_Blender that exists.

THE EIGHTH COMMANDMENT: THE README:
/home/ccaitwo/AIU_Music_Blender/README.md will be kept up to date as the project develops,
...
AIU_Music_Blender runs on the user's own audio files and local downloads, renders locally,
...
AIU_Music_Blender is a "Whole-Word System", for clarity, readability, and understandability,
...
Activities of the AIU_Music_Blender build are logged to the versioned document:
/home/ccaitwo/AIU_Music_Blender/docs/BUILDING_AI_MUSIC_BLENDER_v1.txt
